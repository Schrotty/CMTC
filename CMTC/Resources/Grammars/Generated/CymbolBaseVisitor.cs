...
// ***********************************************************************
// <copyright file="CymbolBaseVisitor.cs" company="CMTC">
...
/// Implements the <see cref="Antlr4.Runtime.Tree.AbstractParseTreeVisitor{Result}" />
/// Implements the <see cref="ICymbolVisitor{Result}" />
/// </summary>
/// <typeparam name="Result">The return type of the visit operation.</typeparam>
/// <seealso cref="Antlr4.Runtime.Tree.AbstractParseTreeVisitor{Result}" />
/// <seealso cref="ICymbolVisitor{Result}" />
...
public partial class CymbolBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICymbolVisitor<Result> {
    ...
    /// <returns>Result.</returns>
    /// <return>The visitor result.</return>
    public virtual Result VisitExpr([NotNull] CymbolParser.ExprContext context) { return VisitChildren(context); }
    /// <summary>
